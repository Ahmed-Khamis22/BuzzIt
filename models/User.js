...
const userSchema = new mongoose.Schema({
  ...
  soloDailyUsage: {
    tenByTenDate: { type: String, default: '' },
    tenByTenGames: { type: Number, default: 0 },
    tenByTenExtraDate: { type: String, default: '' },
    tenByTenExtraGameClaimed: { type: Boolean, default: false },
    dontSayMyWordDate: { type: String, default: '' },
    dontSayMyWordGames: { type: Number, default: 0 },
  },
